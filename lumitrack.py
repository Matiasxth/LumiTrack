...
Original file is located at
    https://colab.research.google.com/drive/14jrdFPaYV7x-xsseUcQNePVGlAQFBswI
"""
...
st.write("Registra los datos de luminarias, como potencia, tipo de poste y ubicación GPS, y expórtalos en un archivo.")

# Función para obtener coordenadas GPS desde el navegador
def get_gps_coordinates():
    ...
    navigator.geolocation.getCurrentPosition(
        ...
        (error) => {
            document.getElementById("gps-coords").value = "Permiso denegado o no disponible.";
        }
    );
    </script>
    """
